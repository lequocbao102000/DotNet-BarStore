...
namespace QLDCPC
{
    public class ExcelExport
    {
        ...
        public const string T_DanhMucKhoa = "THONGKE";
        #endregion
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer,
            ref Dictionary<string, string> Ma, DataGridView dgv)
        {
            if (pReplacer != null)
            {
                ...
                Ma.Add("%HOADON.MAHD", dgv.Rows[1].Cells[0].Value.ToString());
        ...
        public bool ExportKhoa(List<HOADON> dataSource, ref string fileName, bool isPrintPreview,DataGridView dgv)
        {
            // Check if data is null
            ...
            BuildReplacerCurrentDate(ref replacer,ref Ma,dgv);
